...
public class RequestAttribute {
    ...
    public static final String FLOWER_TYPE_LIST = "flowerTypeList";
    ...
    public static final String BASKET_FLOWER_LIST = "basketFlowerList";
    ...
    public static final String REGEXP_NAME = "attribute_regexp_name";
