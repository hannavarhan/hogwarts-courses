...
<div class="grid-container"
    ...
    <div class="grid-y  align-center  text-center" style="height: 700px;">
        ...
        <div class="cell small-3"
             style="font-family: 'SofiaProLight'; font-size: 16pt; text-align: left; padding: 0 10%;">Lorem
            ipsum dolor sit, amet
            consectetur adipisicing elit. Laboriosam quam delectus eos vitae quisquam maiores, sint perspiciatis
            maxime. Incidunt deleniti ad natus voluptatum architecto porro neque dicta itaque molestias eveniet?
        </div>
        <div class="cell grid-x small-1"
             style="font-family: 'SofiaProLight'; font-size: 14pt; text-align: left;padding: 3% 10%;">
            <div class="cell small-7">1.DSZKLGFSJDKLGKLJFDSJKLSDJKL;JKL;SDJGKFJKL;SDKJLGJKL;JK;</div>
            <div class="cell small-3"></div>
            <div class="cell small-2"><input type="checkbox"></div>
        </div>
        <div class="cell grid-x small-1"
             style="font-family: 'SofiaProLight'; font-size: 14pt; text-align: left;padding: 3% 10%;">
            <div class="cell small-7">2.DSZKLGFSJDKLGKLJFDSJKLSDJKL;JKL;SDJGKFJKL;SDKJLGJKL;JK;</div>
            <div class="cell small-3"></div>
            <div class="cell small-2"><input type="checkbox"></div>
        </div>
        <div class="cell grid-x small-1"
             style="font-family: 'SofiaProLight'; font-size: 14pt; text-align: left;padding: 3% 10%;">
            <div class="cell small-7">3.DSZKLGFSJDKLGKLJFDSJKLSDJKL;JKL;SDJGKFJKL;SDKJLGJKL;JK;</div>
            <div class="cell small-3"></div>
            <div class="cell small-2"><input type="checkbox"></div>
        </div>
        <div class="cell grid-x small-1"
             style="font-family: 'SofiaProLight'; font-size: 14pt; text-align: left;padding: 3% 10%;">
            <div class="cell small-7">4.DSZKLGFSJDKLGKLJFDSJKLSDJKL;JKL;SDJGKFJKL;SDKJLGJKL;JK;</div>
            <div class="cell small-3"></div>
            <div class="cell small-2"><input type="checkbox"></div>
        </div>
        <div class="cell grid-x small-1"
             style="font-family: 'SofiaProLight'; font-size: 14pt; text-align: left;padding: 3% 10%;">
            <div class="cell small-7">5.DSZKLGFSJDKLGKLJFDSJKLSDJKL;JKL;SDJGKFJKL;SDKJLGJKL;JK;</div>
            <div class="cell small-3"></div>
            <div class="cell small-2"><input type="checkbox"></div>
        </div>
        <div class="cell grid-x small-1"></div>
        <div class="cell grid-x small-1" style="margin-bottom: 5%;">
            <div class="cell small-4">
                <button class="button">Previous</button> <button class="button">Next</button>
            </div>
        </div>
    </div>
    </form>
